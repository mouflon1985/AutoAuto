...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if btc > 0.00008 or profit >= 5.0:
                sell_result = upbit.sell_market_order("KRW-DOGE")
