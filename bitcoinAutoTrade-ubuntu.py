...
access = "J"
secret = "n"
myToken = "xoxb-1936335540372-1923447449862-S4P7VFyfZvpCYDWCxHAsXJww"
    ...
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and ma5 < current_price and current_price < predicted_close_price:
                krw = get_balance("KRW")
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-BTC", "900000", krw*0.9995)
            ...
            if btc > 0.00008 or profit >= 2.0:
                sell_result = upbit.sell_market_order("KRW-BTC")
